  ...
  return (
    <div className="mx-auto mt-16 w-1/3">
      {isLoading ? (
        ...
        currentResponse && (
          <div>
            <div className="service-card group flex cursor-pointer snap-start flex-col items-start rounded-lg bg-white px-4 py-2 text-center italic shadow-xl transition-all duration-300 hover:bg-[#202127]">
              <svg
              ...
              <p className=" mx-auto font-serif text-lg font-semibold tracking-wide text-gray-500">
                {currentResponse}
              </p>
              <svg
